...
(function ($) {
    ...
    fn.setupDayDetailWindow = function () {
        ...
        html += '           <h4 class="bs-lable">日期范围</h4>';
        html += '           <div class="bs-options-wrapper">';
        html += '               <input class="itext" name="startDay" id="startDay" data-type="startDay" type="text" v-datetimepicker="{type:2,use:true}">';
        html += '               <span class="white-space">-</span>';
        html += '               <input class="itext" name="endDay" id="endDay" data-type="endDay" type="text" v-datetimepicker="{type:2,use:true}">';
        html += '           </div>';
        html += '       </div>';
        html += '       <div class="bs-content bs-week-chekbox">';
        html += '           <h4 class="bs-lable">设置星期</h4>';
        html += '           <div class="bs-options-wrapper">';
        ...
        var cpm = new component().$mount()
        document.getElementById('calendarTab').appendChild(cpm.$el)
    };
